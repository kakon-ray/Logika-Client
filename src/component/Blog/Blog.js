          ...
          <div className="flex justify-center">
            <div className="rounded-lg shadow-lg bg-white dark:bg-slate-900 max-w-sm">
              ...
              <div className="p-6">
                ...
                <button
                  type="button"
                  className=" inline-block px-6 py-2.5 bg-[#14a800] text-white font-medium text-xs leading-tight uppercase rounded shadow-md bg-[#178a08] hover:shadow-lg focus:bg-lime-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                >
                  Details
                </button>
              </div>
